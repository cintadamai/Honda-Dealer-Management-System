...
Namespace HDMS
    ...
    <Persistent("unit_purchase_return_details")>
    Partial Public Class UnitPurchaseReturnDetailsModel
        ...
        Public Property Id() As Long
            ...
            End Set
        End Property
        Dim fRetur As UnitPurchaseReturnModel
        <Persistent("retur")>
        <Association("UnitPurchaseReturnDetailsModelReferencesUnitPurchaseReturnModel")>
        Public Property Retur() As UnitPurchaseReturnModel
            Get
                Return fRetur
            End Get
            Set(ByVal value As UnitPurchaseReturnModel)
                SetPropertyValue(Of UnitPurchaseReturnModel)("Retur", fRetur, value)
            End Set
        End Property
        ...
        <Persistent("model")>
        <Association("UnitPurchaseReturnDetailsModelReferencesUnitModelModel")>
